...
#import losses
import sys
sys.path.append('/kaggle/input/supconloss')
...
base_dir = "/kaggle/input/sentimentdata"
# Read data from files
train_file = os.path.join(base_dir, "labeledTrainData.tsv")
test_file  = os.path.join(base_dir, "testData.tsv")
...
if __name__ == '__main__':
    ...
    result_output.to_csv("/kaggle/working/bert_scratch.csv", index=False, quoting=3)
